...
<section
	...
	"
>
	<div class="mx-auto space-y-4 text-center md:space-y-8">
...
<footer class="full-width bg-veryDarkViolet text-white">
	<div class="center-content-container px-6 py-[72px]">
		<div
			class="flex flex-col items-center gap-12 md:flex-row md:items-start md:justify-between"
		>
			<svg
				...
				/></svg
			>
			<div class="flex flex-col gap-9 text-center md:flex-row md:gap-24 md:text-left">
				<ul>
					<h4>Features</h4>
